...
await run({
  format: requestedFormat === 'json' || requestedFormat === 'quiet' || requestedFormat === 'markdown' || requestedFormat === 'mitata'
    ? requestedFormat
    : 'mitata',
  colors: true,
  filter: requestedFilter ? new RegExp(requestedFilter) : undefined,
})
